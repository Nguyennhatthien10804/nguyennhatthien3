...
<section class="product spad">
        ...
        <section class="trend spad">
            ...
            <li>
                <strong>Title:</strong> {{ $bestSeller->title }}<br>
                <strong>Author:</strong> {{ $bestSeller->author }}<br>
                <strong>Publication Date:</strong> {{ $bestSeller->publication_date }}<br>
                <strong>Genre:</strong> {{ $bestSeller->genre }}<br>
                <strong>Price:</strong> ${{ $bestSeller->price }}<br>
                <strong>Stock:</strong> {{ $bestSeller->stock }}<br>
            </li>
        @endforeach
                            <div class="trend__item">
                                <div class="trend__item__pic">
